...
<p align="center">
  <a href="https://www.atlascloud.ai/?utm_source=github&utm_medium=link&utm_campaign=LucidFlux">
    <img src="./assets/atlas-cloud-logo.png" alt="Atlas Cloud" width="200">
  </a>
</p>

> 🎁 **[Atlas Cloud](https://www.atlascloud.ai/?utm_source=github&utm_medium=link&utm_campaign=LucidFlux)** provides a unified Media API for 300+ AI image and video generation models — replace or augment LucidFlux's local Flux.1 inference with cloud-based calls to get scalable, GPU-free image restoration and generation, ideal for production deployments and joint PR campaigns — [coding plan](https://www.atlascloud.ai/console/coding-plan)
